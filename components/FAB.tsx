...
import { Phone, X, MessageCircle, UserCircle } from "lucide-react";
      ...
      {open && (
        <div className="flex flex-col items-end gap-3 mb-2">
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg shadow-lg bg-teal-600/90 text-white hover:bg-teal-700 font-semibold border border-teal-700 transition"
            aria-label="Call Us"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg shadow-lg bg-green-600/90 text-white hover:bg-green-700 font-semibold border border-green-700 transition"
            aria-label="WhatsApp"
          >
          ...
          <button
            ...
            className="flex items-center gap-2 px-4 py-2 rounded-lg shadow-lg bg-slate-700/90 text-white hover:bg-slate-800 font-semibold border border-slate-800 transition"
